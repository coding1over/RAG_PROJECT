...
# pymilvus 2.6.0+ 大重构
# 永久删除 旧版 connections.connect()
# 永久删除 旧版 Collection ORM 类
# 只保留唯一连接方式：MilvusClient(uri=...)
# langchain-milvus 天生不兼容
# 哪怕升级到最新版，它底层依然依赖已废弃的旧接口
# → 这是死结，永远修不好！
class MilvusVectorSave:
    ...
    def create_collection(self):
        ...
        index_params.add_index(
            ...
            index_type="HNSW",  # Inverted index type for sparse vectors
            metric_type="IP",
